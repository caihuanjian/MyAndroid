...
public class ImagePipelineConfigUtils {
    ...
    //使用的缓存数量
//    private static final int MAX_MEMORY_CACHE_SIZE = MAX_HEAP_SIZE / 10;
    private static final int MAX_MEMORY_CACHE_SIZE = 1 * ByteConstants.MB;
