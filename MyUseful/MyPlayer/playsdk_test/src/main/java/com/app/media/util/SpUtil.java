...
public class SpUtil {
    ...
    public static void writeLong(Context context, String configName, String key, long value) {
        SharedPreferences preference = context.getSharedPreferences(
                configName, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preference.edit();
    ...
    public static long readLong(Context context, String configName, String key, long defValue) {
        SharedPreferences preference = context.getSharedPreferences(
                configName, Context.MODE_PRIVATE);
