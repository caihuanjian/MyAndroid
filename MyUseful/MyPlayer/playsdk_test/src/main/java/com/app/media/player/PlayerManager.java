...
import com.app.media.player.constant.MediaFormat;
import com.app.media.player.constant.PlayerType;
import com.app.media.player.custom.MediaPlayHelper;
import com.app.media.player.exo.ExoAudioPlayHelper;
import com.app.media.player.util.MediaUtil;
...
//        mPlayerList.add(PlayerType.);
     ...
     * @return
     */
    public IPlayHelper getPlayer(IPlayHelper currentPlayer, String playUrl, @PlayerType int playerType) {
        IPlayHelper playHelper = null;
        if (playerType != PlayerType.NONE) {
            playHelper = playerList.get(playerType);
        }
        if (playHelper == null) {
            playHelper = getPlayer(currentPlayer, playUrl, null);
        }
        return playHelper;
    }
