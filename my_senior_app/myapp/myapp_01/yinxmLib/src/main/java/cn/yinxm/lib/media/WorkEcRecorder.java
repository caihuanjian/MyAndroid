...
public class WorkEcRecorder {
    ...
    public WorkEcRecorder(Context context, String fileDir) {
        this(context, fileDir, null);
    }

    public WorkEcRecorder(Context context, String fileDir, Handler handler) {
        mContext=context;
        isRecording = false;
    ...
    public void startRecord() {
        LogUtil.d("[WorkEcRecorder.startRecord] isRecording=" + isRecording + ", mRecorder=" + mRecorder);
//            new Thread(recordThread).start();
    ...
    public float stopRecord() {
        LogUtil.d("[WorkEcRecorder.stopRecord] isRecording=" + isRecording + "， mRecorder=" + mRecorder + ", recordFilePath=" + recordFilePath);
    ...
    public void cancelRecord() {
        LogUtil.d("[WorkEcRecorder.cancelRecord] isRecording=" + isRecording + "， mRecorder=" + mRecorder);
        isUpdateVoiceLevel = false;
        if (mRecorder != null) {
            try {
                if (isRecording) {
...
//                LogUtil.d("sleep end");
                ...
                isUserCancel = false;
                LogUtil.d("WorkEcRecorder.RecordThread mRecorder=" + mRecorder);
                try {
                    mRecorder.prepare();
                } catch (Exception e) {
...
//                            LogUtil.d("音量级别="+msg.what);
                ...
                LogUtil.e("WorkEcRecorder.startRecord 录音异常", e);
            }
        }
    }
